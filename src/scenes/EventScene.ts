...
export class EventScene extends Phaser.Scene {
  ...
  create() {
    ...
    panel(this, W / 2, 205, 354, 146, { fill: COLORS.cream, stroke: COLORS.gold, radius: 24 });
    ...
    event.milestones.forEach((milestone, index) => {
      ...
      panel(this, 215, y, 310, 56, { fill: done ? 0xe4fff0 : ready ? 0xfff0bf : 0xeaf7ff, stroke: ready ? COLORS.gold : COLORS.outline, radius: 16 });
      this.add.circle(43, y, 24, done ? COLORS.mintDark : ready ? COLORS.goldDark : 0x549ac9).setStrokeStyle(3, 0xffffff);
      gameIcon(this, 43, y, done ? '✓' : 'chest', 35);
      ...
      const claim = button(this, 319, y, 90, 40, done ? 'Done ✓' : ready ? 'CLAIM' : 'Locked', () => this.claimMilestone(index), COLORS.gold, ready && !done ? 'gold' : 'muted');
